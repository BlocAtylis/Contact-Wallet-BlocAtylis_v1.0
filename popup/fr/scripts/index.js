...
var inputTitle = document.querySelector('.new-contact input');
var inputBody = document.querySelector('.new-contact textarea');

var noteContainer = document.querySelector('.contact-container');
...
function displayNote(title, body) {
  ...
  deleteBtn.textContent = 'Supprimer ce contact';
  ...
  updateBtn.textContent = 'Modifier Contact';
